...
import 'package:bitcoin_chart_assignment/core/app_tracing_logger.dart';
import 'package:bitcoin_chart_assignment/core/components/app_toast.dart';
import 'package:bitcoin_chart_assignment/core/connection_checker.dart';
...
typedef AppStateNotifierProvider<STORE extends AppStateNotifier<AppEvent, STATE>, STATE>
    = StateNotifierProvider<STORE, STATE>;

abstract class AppHookConsumerWidget<STORE extends AppStateNotifier<AppEvent, STATE>, STATE>
